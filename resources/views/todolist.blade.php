...
<table class='table text-gray-600 dark:text-gray-400' style="padding:0 15px 0 15px;">
    <tr>
            <td style="padding:0 15px 0 15px;">Id</td>
            <td style="padding:0 15px 0 15px;">Task</td>
            <td style="padding:0 15px 0 15px;">Stvoreno</td>
            <td style="padding:0 15px 0 15px;">Action</td>
    </tr>
            @foreach ($todo_arr as $todo)
            <tr>
                <td style="padding:0 15px 0 15px;"> {{$todo->id}}</td>
                <td style="padding:0 15px 0 15px;">{{$todo->tasks}}</td>
                <td style="padding:0 15px 0 15px;">{{$todo->created_at}}</td>
                <td style="padding:0 15px 0 15px;"> <a href="delete/{{$todo->id}}">X</a>
            </tr>
            @endforeach
            <a href='create' class="btn btn-success, text-gray-600 dark:text-gray-400 " style="padding:0 15px 0 15px;" > Stvori novi zadatak</a>
</table>   
